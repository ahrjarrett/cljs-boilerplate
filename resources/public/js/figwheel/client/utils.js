...
var or__26427__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj33286 = {"detail":data};
return obj33286;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26415__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26415__auto__)){
var and__26415__auto____$1 = (window["CustomEvent"]);
...
var args33291 = [];
var len__27540__auto___33297 = arguments.length;
var i__27541__auto___33298 = (0);
while(true){
if((i__27541__auto___33298 < len__27540__auto___33297)){
args33291.push((arguments[i__27541__auto___33298]));

var G__33299 = (i__27541__auto___33298 + (1));
i__27541__auto___33298 = G__33299;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33291.length)].join('')));
...
var f = (function (){var pred__33294 = cljs.core._EQ_;
var expr__33295 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33294.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33295))){
return ((function (pred__33294,expr__33295){
return (function (p1__33287_SHARP_){
return console.warn(p1__33287_SHARP_);
});
;})(pred__33294,expr__33295))
} else {
if(cljs.core.truth_(pred__33294.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33295))){
return ((function (pred__33294,expr__33295){
return (function (p1__33288_SHARP_){
return console.debug(p1__33288_SHARP_);
});
;})(pred__33294,expr__33295))
} else {
if(cljs.core.truth_(pred__33294.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33295))){
return ((function (pred__33294,expr__33295){
return (function (p1__33289_SHARP_){
return console.error(p1__33289_SHARP_);
});
;})(pred__33294,expr__33295))
} else {
return ((function (pred__33294,expr__33295){
return (function (p1__33290_SHARP_){
return console.log(p1__33290_SHARP_);
});
;})(pred__33294,expr__33295))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33301){
var map__33304 = p__33301;
var map__33304__$1 = ((((!((map__33304 == null)))?((((map__33304.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33304.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33304):map__33304);
var opts = map__33304__$1;
var eval_fn = cljs.core.get.call(null,map__33304__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33306_SHARP_);
});})(new_def))
);
...
return (function (p__33307){
var vec__33308 = p__33307;
var ky = cljs.core.nth.call(null,vec__33308,(0),null);
var v = cljs.core.nth.call(null,vec__33308,(1),null);
...
var args33311 = [];
var len__27540__auto___33314 = arguments.length;
var i__27541__auto___33315 = (0);
while(true){
if((i__27541__auto___33315 < len__27540__auto___33314)){
args33311.push((arguments[i__27541__auto___33315]));

var G__33316 = (i__27541__auto___33315 + (1));
i__27541__auto___33315 = G__33316;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33311.length)].join('')));
...
if(cljs.core.truth_((function (){var and__26415__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1495581589155